  ...
  $(document).ready(function() {
    ...
    $('#show_data').on('click', '.item_edit', function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          $.each(data, function(NPP, nama, sex, id_status, kode_bagian, kode_divisi, kode_jabatan, tgl_masuk_format, tgl_keluar_format, tgl_kontrak_format, norek, gapok, tunjangan_tetap, tunjangan_tidak_tetap, tunjangan_pss, potongan_lain, bpjs, bonus, target, potongan_target, dapat_lain) {
